import React, { ImgHTMLAttributes, JSX, memo, ReactElement, useLayoutEffect, useState } from 'react'
...
const AppImage: React.FC<IAppImageProps> = memo((props: IAppImageProps): JSX.Element => {
